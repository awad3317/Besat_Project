...
@section('content')
    ...
    <div dir="rtl" class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
            <!-- نموذج تسجيل الدخول -->
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                <div class="mx-auto w-full max-w-md pt-10 text-right">
                    <a href="{{ url('/') }}"
                        class="inline-flex items-center text-sm text-gray-500 transition-colors hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                        <svg class="stroke-current rotate-180 ml-1" xmlns="http://www.w3.org/2000/svg" width="20"
                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        <div class="mb-5 sm:mb-8 text-right">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <input id="phone" name="phone" type="text" value="{{ old('phone') }}" required
                                        autofocus placeholder="أدخل رقم هاتفك"
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input id="password" name="password" :type="showPassword ? 'text' : 'password'"
                                            ...
                                            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-4 pl-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:text-white/90" />
                                ...
                                <div class="flex items-center justify-between">
                                    <label class="flex items-center text-sm font-normal text-gray-700 dark:text-gray-400">
                        ...
                        <div class="mt-5 text-center">
                            <p class="text-sm font-normal text-gray-700 dark:text-gray-400">
                                ...
                                <a href="{{ route('register') }}"
                                    class="text-brand-500 hover:text-brand-600 dark:text-brand-400">سجّل الآن</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center text-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="{{ url('/') }}" class="mb-4 block">
                            <img src="{{ asset('tailadmin/build/src/images/user/Busat.png') }}" alt="الشعار" />
                        </a>
                        <p class="text-gray-300 mt-4">مرحبًا بك في <span class="text-brand-400">بساط</span></p>
                    </div>
                </div>
            </div>

            <!-- زر تبديل الوضع الليلي -->
            <div class="fixed z-50 hidden bottom-6 left-0 sm:block">
                <button
