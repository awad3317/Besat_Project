<div x-data="{ showDeleteModal: false, deleteAction: '' }" 
     x-on:open-delete-modal.window="showDeleteModal = true; deleteAction = $event.detail.action">
            ...
            <div class="text-center py-4">
                ...
                <div class="flex justify-center mt-6 gap-3">
                    <button @click="showDeleteModal = false" type="button"
                        class="px-6 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                        {{ $cancelButton ?? 'إلغاء' }}
                    </button>
