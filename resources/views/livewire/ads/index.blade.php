<div class="p-4 min-h-screen bg-gray-50 md:p-6 lg:p-8 dark:bg-gray-900 font-outfit" dir="rtl">
    <div class="max-w-[1400px] mx-auto space-y-6">

        {{-- Stats Cards --}}
        <div class="flex flex-col flex-wrap gap-4 mb-1 sm:flex-row md:gap-6">
            ...
            <div wire:click="applyFilter('all')" wire:loading.class="opacity-50"
                ...
                <div
                    class="flex flex-shrink-0 justify-center items-center w-12 h-12 bg-gray-50 rounded-xl border border-gray-100 dark:border-gray-700 shadow-theme-xs dark:bg-gray-800 text-brand-500">
                    <svg width="26" height="26" fill="none" stroke="#dc6803" stroke-width="1.5"
                        viewBox="0 0 24 24">
                ...
                <div class="mt-4 w-full">
                    ...
                    <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white/90">{{ $this->stats['total'] }}
                    </h4>
                </div>
            </div>
            ...
            <div wire:click="applyFilter('active')" wire:loading.class="opacity-50"
                ...
                <div
                    class="flex flex-shrink-0 justify-center items-center w-10 h-10 bg-gray-50 rounded-lg border-2 border-gray-100 dark:border-gray-700 shadow-theme-xs dark:bg-gray-800 text-brand-500">
                ...
                <div class="mt-4 w-full">
                    ...
                    <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white/90">{{ $this->stats['active'] }}
                    </h4>
                </div>
            </div>
            ...
            <div wire:click="applyFilter('inactive')" wire:loading.class="opacity-50"
                ...
                <div
                    ...
                    <svg width="30" height="30" viewBox="0 0 512 512" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#dc6803"
                        stroke="#dc6803">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                ...
                <div class="mt-4 w-full">
                    ...
                    <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white/90">{{ $this->stats['inactive'] }}
                    </h4>
                </div>
            </div>
        ...
        {{-- Ads Grid Section --}}
        <div class="pt-4 min-h-screen bg-gray-50 lg:p-8 dark:bg-gray-900 font-outfit" dir="rtl">
            <div class="max-w-[1400px] mx-auto space-y-6">
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="p-6">
                        <div wire:loading.class.delay="opacity-50"
                            wire:target="applyFilter, nextPage, previousPage, gotoPage"
                            class="grid grid-cols-1 gap-6 transition-opacity md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">

                            @forelse ($this->ads as $ad)
                                <div wire:key="ad-{{ $ad->id }}"
                                    class="flex overflow-visible flex-col bg-white rounded-xl border border-gray-200 transition-all duration-300 group dark:bg-gray-dark dark:border-gray-700 shadow-theme-sm hover:shadow-theme-md">

                                    <div
                                        class="flex overflow-hidden relative justify-center items-center w-full h-52 bg-gray-100 rounded-t-xl dark:bg-gray-800 shrink-0">
                                        <img src="{{ asset($ad->image) }}" alt="إعلان"
                                            class="object-contain p-2 w-full h-full transition-transform duration-500 group-hover:scale-105">
                                    </div>
                                    ...
                                    <div class="flex flex-col flex-grow justify-between p-5">
                                        ...
                                        <div class="flex justify-between items-center pt-3 mt-4 border-t border-gray-50 dark:border-gray-800"
                                            x-data="{ openOptions: false }">
                                            <div>
                                                <span
                                                    class="px-2.5 py-1 rounded-md text-[10px] font-bold tracking-wider shadow-sm {{ $ad->is_active ? 'bg-success-50 text-success-700 dark:bg-success-500/10 dark:text-success-400' : 'bg-error-50 text-error-700 dark:bg-error-500/10 dark:text-error-400' }}">
                                                    {{ $ad->is_active ? 'مفعل' : 'غير مفعل' }}
                                                </span>
                                            </div>

                                            <div class="flex relative flex-shrink-0 justify-center items-center">
                                                <button @click="openOptions = !openOptions"
                                                    @click.away="openOptions = false" class="actions-trigger-btn">
                                                ...
                                                <div x-show="openOptions" x-transition.opacity.duration.200ms x-cloak
                                                    class="right-0 left-auto actions-dropdown-menu">
                                                    ...
                                                    @else
                                                        <button type="button"
                                                            ...
                                                            <svg class="w-4 h-4 text-success-500" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <form action="{{ route('ads.destroy', $ad->id) }}" method="POST"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="delete-btn actions-dropdown-item text-error-600 dark:text-error-500 hover:bg-error-50 dark:hover:bg-error-950/20">
                                                            <svg class="w-4 h-4 text-error-500" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            @empty
                                <div class="col-span-1 py-16 text-center md:col-span-2 xl:col-span-3 2xl:col-span-4">
                                    <p class="text-lg font-medium text-gray-500 dark:text-gray-400">لا توجد إعلانات
                                        مضافة حالياً.</p>
                                    <p class="mt-1 text-sm text-gray-400">اضغط على زر "إضافة إعلان جديد" بالأعلى للبدء.
                                    </p>
                                </div>
                            @endforelse
