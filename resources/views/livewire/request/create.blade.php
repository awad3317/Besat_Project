<div class="grid grid-cols-1 gap-y-5 gap-x-6 mt-2 sm:grid-cols-2">
        ...
        <div class="flex flex-col gap-4 w-full sm:flex-row">
            ...
            <label class="flex-1 cursor-pointer">
                <input type="radio" name="payment_method" value="cash" wire:model.live="payment_method"
                    class="sr-only">
                <div
                    class="p-5 rounded-2xl border-2 transition-all duration-200 h-full flex flex-col items-center justify-center gap-3 {{ $payment_method === 'cash' ? 'border-brand-500 bg-brand-50 dark:border-brand-500 dark:bg-brand-900/20 shadow-sm' : 'border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-700 hover:border-brand-300 hover:bg-gray-50 dark:hover:bg-gray-800/80' }}">
                    <i
    ...
    @if ($price_details)
        ...
        <div class="overflow-hidden relative col-span-1 mt-6 bg-white rounded-2xl border border-gray-200 transition-all duration-300 sm:col-span-2 dark:bg-gray-900 dark:border-gray-800 shadow-theme-sm"
    ...
    <div class="flex overflow-hidden relative justify-between items-center p-4 mt-3 bg-gradient-to-l to-white rounded-xl border shadow-sm transition-all duration-300 border-success-200 dark:border-success-500/20 from-success-50 dark:from-success-500/10 dark:to-gray-900 hover:shadow-md">
        
        <!-- تأثير ديكوري في الخلفية (Glow) -->
        <div class="absolute -top-4 -left-4 w-16 h-16 rounded-full blur-xl pointer-events-none bg-success-400/10 dark:bg-success-500/10"></div>

        <div class="flex relative z-10 gap-3 items-center">
            <!-- صندوق الأيقونة -->
            <div class="flex justify-center items-center w-8 h-8 rounded-lg bg-success-100 dark:bg-success-500/20 text-success-600 dark:text-success-400 shadow-theme-xs">
            ...
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center">
                <span class="text-sm font-bold text-success-700 dark:text-success-400">تم تطبيق الخصم</span>
                @if($coupon_code)
                    <!-- شارة كود الخصم -->
                    <span class="inline-flex items-center px-2 py-0.5 rounded text-[11px] font-black tracking-wider text-success-600 dark:text-success-400 bg-white dark:bg-gray-800 border border-success-200 dark:border-success-500/30 uppercase shadow-sm">
                        {{ $coupon_code }}
                    </span>
                @endif
            </div>
        ...
        <!-- قيمة الخصم -->
        <div class="relative z-10 text-base font-black text-success-600 dark:text-success-400" dir="ltr">
...
@endif
                    ...
                    <div
                        ...
                        <div class="text-left" dir="ltr">
                            <span class="font-bold text-gray-400 text-theme-xs dark:text-gray-500 me-1">YER</span>
                            <span
    ...
    @else
        ...
        <div class="col-span-1 mt-6 sm:col-span-2" style="grid-column: 1 / -1;">
            <div
                class="flex flex-col gap-4 justify-center items-center p-10 text-center bg-gray-50 rounded-2xl border-2 border-gray-200 border-dashed transition-all dark:bg-gray-800/50 dark:border-gray-700">
