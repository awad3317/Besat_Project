                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <div wire:loading.class.delay="opacity-50"
                            ...
                            <div wire:key="coupon-{{ $coupon->id }}"
                                class="group bg-white dark:bg-gray-dark dark:border-gray-700 rounded-xl border shadow-theme-sm hover:shadow-theme-md transition-all duration-300 overflow-visible flex flex-col">
                                ...
                                <div
                                    class="pr-6 pl-2 py-4 bg-gray-50/50 dark:bg-white/[0.03] border-t border-gray-100 dark:border-gray-800 flex items-center justify-between rounded-b-xl">
                                    {{-- Progress Bar --}}
                                    ...
                                    {{-- Action Buttons --}}
                                    <div class="flex relative justify-center items-center mx-4 flex-shrink-0" x-data="{ openOptions: false }">
