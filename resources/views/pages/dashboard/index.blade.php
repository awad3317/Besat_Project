...
@section('addButton')
  ...
  {{-- زر إرسال إشعار تجريبي (للاختبار فقط) --}}
  <form action="{{ route('dashboard.send-test-notification') }}" method="POST" class="inline-flex">
    @csrf
    <button type="submit"
      class="bg-success-500 hover:bg-success-600 h-10 rounded-lg px-6 py-2 text-sm font-medium text-white min-w-[100px] inline-flex items-center justify-center gap-2 transition-colors duration-200">
