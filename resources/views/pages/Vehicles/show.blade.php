        ...
        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
          @foreach ($vehicle->pricing as $index => $price)
            <tr>
              ...
              <td class="py-3">
                <div class="flex items-center justify-center">
                  <div class="flex items-center justify-center gap-1" x-data="{ isLoading: false }">

                    <button @click="isLoading = true; window.location.href='{{ route('vehiclePricing.edit', $price->id) }}'"
                      :disabled="isLoading"
                      class="relative flex items-center gap-1 rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-theme-xs font-medium text-gray-700 transition-all hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-white disabled:opacity-75 disabled:cursor-not-allowed">
                      <!-- Loading Spinner -->
                      <svg x-show="isLoading" class="animate-spin w-4 h-4 text-gray-700 dark:text-white"
